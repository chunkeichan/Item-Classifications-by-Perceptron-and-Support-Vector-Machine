...
for i in range(0,20): 
    """ Q3a: Fill in your answers, replace t with the PC scores for class 0 and class 1 respectively"""
...
fig.savefig('Q3a_PCcatterplot.png', dpi = 200)   # save the figure to file
fig.show()
plt.close(fig)  
